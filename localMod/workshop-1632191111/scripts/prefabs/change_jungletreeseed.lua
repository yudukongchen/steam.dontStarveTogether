...
local assets =
{
	...
	Asset("IMAGE","images/inventoryimages/change_jungletreeseed.tex"),
	Asset("ATLAS","images/inventoryimages/change_jungletreeseed.xml")
...
local function growtree(inst)
    ...
    inst.growtask = nil
    inst.growtime = nil
	local tree = SpawnPrefab("change_jungletree_short") 
    if tree then 
...
local function fn()
	...
	inst.components.inventoryitem.imagename = "change_jungletreeseed"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/change_jungletreeseed.xml"
...
return Prefab( "change_jungletreeseed", fn, assets),
	   MakePlacer( "change_jungletreeseed_placer", "jungletreeseed", "jungletreeseed", "idle_planted" ) 
