...
local function createmachine(level, name, soundprefix, techtree, giftsound,scale)
    ...
    local assets =
    {
        Asset("ANIM", "anim/change_science_buildings.zip"),
    ...
    local function fn()
        ...
        inst.AnimState:SetBank("change_science_buildings")
        inst.AnimState:SetBuild("change_science_buildings")
...
return 
    createmachine(2, "change_researchlab2", "lvl2", TUNING.PROTOTYPER_TREES.ALCHEMYMACHINE, "alchemy",SCALE),
    MakePlacer("change_researchlab2_placer", "change_science_buildings", "change_science_buildings", "change_researchlab2",nil,nil,nil,SCALE),
	createmachine(3, "change_researchlab3", "lvl3", TUNING.PROTOTYPER_TREES.SHADOWMANIPULATOR, "alchemy",SCALE),
    MakePlacer("change_researchlab3_placer", "change_science_buildings", "change_science_buildings", "change_researchlab3",nil,nil,nil,SCALE)
