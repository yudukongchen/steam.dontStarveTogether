...
local builds =
{
	normal = {
		...
		prefab_name="change_jungletree",
		normal_loot = {"log", "log", "change_jungletreeseed"},
		short_loot = {"log"},
		tall_loot = {"log", "log", "log", "change_jungletreeseed", "change_jungletreeseed"},
...
local function makefn(build, stage, data)
	...
	local function fn(Sim)
		...
		minimap:SetIcon("minimap_jungletree.png")
...
return tree("change_jungletree", "normal", 0),
		tree("change_jungletree_normal", "normal", 2),
		tree("change_jungletree_tall", "normal", 3),
		tree("change_jungletree_short", "normal", 1),
		tree("change_jungletree_burnt", "normal", 0, "burnt"),
		tree("change_jungletree_stump", "normal", 0, "stump")
