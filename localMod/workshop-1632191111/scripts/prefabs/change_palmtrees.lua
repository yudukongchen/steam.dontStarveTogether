...
SetSharedLootTable('change_palmtree_short',  {{"log", 1.0}, --[[{"palmleaf", 1.0}--]]})
SetSharedLootTable('change_palmtree_normal', {{"log", 1.0},{"log", 1.0}, --[[{"palmleaf", 1.0}--]]})
SetSharedLootTable('change_palmtree_tall',  {{"log", 1.0}, {"log", 1.0}, {"change_coconut", 1.0}, {"change_coconut", 0.33},--[[{"palmleaf", 1.0}--]]})

local builds =
{
	normal = {
		file="palmtree_build",
		prefab_name="change_palmtree",
		normal_loot = 'change_palmtree_normal',
		short_loot = 'change_palmtree_short',
		tall_loot = 'change_palmtree_tall',
		--leif="treeguard",
		leif="leif",
	},
	--[[
...
local growth_stages =
{
	{name="short", time = function(inst) return GetRandomWithVariance(PALMTREE_GROW_TIME[1].base, PALMTREE_GROW_TIME[1].random) end, fn = function(inst) SetShort(inst) end,  growfn = function(inst) GrowShort(inst) end , leifscale=.7 },
	{name="normal", time = function(inst) return GetRandomWithVariance(PALMTREE_GROW_TIME[2].base, PALMTREE_GROW_TIME[2].random) end, fn = function(inst) SetNormal(inst) end, growfn = function(inst) GrowNormal(inst) end, leifscale=1 },
	{name="tall", time = function(inst) return GetRandomWithVariance(PALMTREE_GROW_TIME[3].base, PALMTREE_GROW_TIME[3].random) end, fn = function(inst) SetTall(inst) end, growfn = function(inst) GrowTall(inst) end, leifscale=1.25 },
...
local function makefn(build, stage, data)
	...
	local function fn()
		...
		minimap:SetIcon("minimap_palmtree.png")
...
return tree("change_palmtree", "normal", 0),
		tree("change_palmtree_normal", "normal", 2),
		tree("change_palmtree_tall", "normal", 3),
		tree("change_palmtree_short", "normal", 1),
		tree("change_palmtree_burnt", "normal", 0, "burnt"),
		tree("change_palmtree_stump", "normal", 0, "stump")
