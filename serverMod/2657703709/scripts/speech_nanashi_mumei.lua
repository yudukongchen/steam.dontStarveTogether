...
return{
	ACTIONFAIL =
	{
        APPRAISE =
        {
            NOTNOW = " Can i have your attention please?",
        },
        REPAIR =
        {
            WRONGPIECE = "Wait, which piece was i'm looking for again?",
        },
        BUILD =
        {
            MOUNTED = "Nuh-uh, better put me down first woozy!",
            HASPET = "Maybe another time, i've got one already.",
        },
		SHAVE =
		{
			AWAKEBEEFALO = "Perhaps it is not safe to do it when they're still awake...",
			GENERIC = "Nope.",
			NOBITS = "I wouldn't go that far ",
--fallback to speech_wilson.lua             REFUSE = "only_used_by_woodie",
            SOMEONEELSESBEEFALO = "I might have forgor a lot of things, but this is certainly ain't my woozy.",
		},
		STORE =
		{
			GENERIC = "Don't think i can cram anymore into it.",
			NOTALLOWED = "Guess i'll have to wait for my turn.",
			INUSE = "Sure, buddy. Take your time.",
            NOTMASTERCHEF = "I'd love to try, but i'm afraid the chef isn't going to be pleased having his pot burned.",
		},
        CONSTRUCT =
        {
            INUSE = "Hmm... Guess i'll have to wait for my turn.",
            NOTALLOWED = "Where was this suppose to go again?.",
            EMPTY = "I need something to build with first!",
            MISMATCH = "This isn't the right spot.",
        },
		RUMMAGE =
		{
		...
		UNLOCK =
        {
--fallback to speech_wilson.lua         	WRONGKEY = "I can't do that. Wait, can i?",
        },
		USEKLAUSSACKKEY =
        {
		...
		ACTIVATE =
		{
			LOCKED_GATE = "You can't keep me from my berries forever!",
        ...
        FISH_OCEAN =
		{
			TOODEEP = "Come here little fishy. Get on my hook!!",
		},
        OCEAN_FISHING_POND =
		{
			WRONGGEAR = "Isn't that a bit much?",
		},
...
--fallback to speech_wilson.lua         },
        ...
        {
            GENERIC = "Nope !",
            DEAD = "I don't think they can have it without a hand.",
            ...
            WRONGGEM = "Is it the blue rock ? Or the red one ?",
            NOTSTAFF = "I don't have to jam stuff into every hole I see!",
            MUSHROOMFARM_NEEDSSHROOM = "It's gonna take some shrooms to grow.",
            MUSHROOMFARM_NEEDSLOG = "I think it needs the log with a funny face",
            MUSHROOMFARM_NOMOONALLOWED = "These mushrooms won't grow!",
            SLOTFULL = "Naw, can't make it fit.",
            FOODFULL = "I have to wait for it to eat this one first.",
            NOTDISH = "Should i try it first ? Looks unsafe though",
            DUPLICATE = "Oh, i think i rember this one",
...
--fallback to speech_wilson.lua             NOTATRIUMKEY = "It's not quite the right shape.",
        ...
        GIVETOPLAYER =
        {
            FULL = "Hey have this.I think it's yours. Or was it mine?",
            DEAD = "Can you return to life and have this please?",
        ...
        WRITE =
        {
            GENERIC = "Hold on,I'll write it down so i can rember.",
            INUSE = "Can i write when you're done?",
        },
        DRAW =
        {
            NOIMAGE = "Let's draw something cute, but what then?",
        },
        CHANGEIN =
        {
        ...
        SADDLE =
        {
            TARGETINCOMBAT = "I'll try, but i am no matador.",
        },
        TEACH =
        {
            --Recipes/Teacher
            ...
            WRONGWORLD = "I think it isn't the right direction, or is it ?",
...
--fallback to speech_wilson.lua 			NO_HEAVY_LIFTING = "only_used_by_wanda",
        ...
        ROW_FAIL =
        {
            ...
            BAD_TIMING2 = "Oof, i'll need to change my clothes then",
        },
        LOWER_SAIL_FAIL =
        {
            "Set sail, fellow sailors !",
...
--fallback to speech_wilson.lua             SAMESONG = "only_used_by_wathgrithr",
        ...
        {
            GENERIC = "Wait, I knew this already? But it seems so new. ",
            FERTILIZER = "Well, that's about all I ever want to know about this stuff.",
        },
        FILL_OCEAN =
        {
            UNSUITABLE_FOR_PLANTS = "Wait, can i use these on berries instead ?",
        },
        POUR_WATER =
        {
        ...
        {
            OUT_OF_WATER = "Berries needs way less water. Just saying .",
        },
        USEITEMON =
        {
...
--fallback to speech_wilson.lua             FULL = "only_used_by_wolfang",
	...
	ANNOUNCE_BOAT_LEAK = "Uh oh",
	ANNOUNCE_BOAT_SINK = "I don't think owls can swim... Can they ?",
...
--fallback to speech_wilson.lua         WIMPY = "only_used_by_wolfang",
	...
	ANNOUNCE_BEES = "Aaaah! Not the bees!",
	ANNOUNCE_BOOMERANG = "Ouch.I'll catch you next time then",
	ANNOUNCE_CHARLIE = "Who's that lady with roses on her head ?",
	ANNOUNCE_CHARLIE_ATTACK = "OUCH! How dare you!",
--fallback to speech_wilson.lua 	ANNOUNCE_CHARLIE_MISSED = "only_used_by_winona", --winona specific
	ANNOUNCE_COLD = "Achoo! I need to find a heat source quick !",
	ANNOUNCE_HOT = "Something smells burnt. Oh wait, it's me. Ahhhhhh",
	ANNOUNCE_CRAFTING_FAIL = "I'm missing something.",
	ANNOUNCE_DEERCLOPS = "Look like we have visitors, should i give them a warm welcome?",
	ANNOUNCE_CAVEIN = "I better protect my head!",
	ANNOUNCE_ANTLION_SINKHOLE =
	{
		"The ground is going nuts!",
		"It's coming!",
		"Uh oh, i need help!",
	},
    ...
    ANNOUNCE_DUSK = "It's getting dark already. Time to find shelter.",
...
--fallback to speech_wilson.lua 	ANNOUNCE_DISCHARGE = "only_used_by_wx78",
	...
	ANNOUNCE_EAT =
	{
		GENERIC = "Yummy yummy in my tummy!",
		PAINFUL = "Ewwwww!",
		SPOILED = "Umm... I don't think that's food anymore.",
		STALE = "Ok. That was kinda gross.",
		INVALID = "Is it even edible?",
        YUCKY = "Eeeew, no way!",
...
--fallback to speech_wilson.lua 		TASTY = "only_used_by_warly",
	...
	ANNOUNCE_ENTER_DARK = "Where did I put my lantern!?",
	ANNOUNCE_ENTER_LIGHT = "Oh, I can see! I thought I'd gone blind.",
	ANNOUNCE_FREEDOM = "I'm free now!",
	ANNOUNCE_HIGHRESEARCH = "I rember even more!",
	ANNOUNCE_HOUNDS = "OMG, the hounds!",
	ANNOUNCE_WORMS = "I heard some weird noise underground.",
	ANNOUNCE_HUNGRY = "I need more berries!",
	...
	ANNOUNCE_KNOCKEDOUT = "*autotune noises*",
    ...
    ANNOUNCE_NOMOUNTEDGIFT = "Let's see what we've got buddy, but you're gonna have to put me down first.",
	ANNOUNCE_NODANGERSLEEP = "Let's sleep after we take out all of the threats",
	ANNOUNCE_NODAYSLEEP = "Have you ever seen someone sleeps with their eyes kind of open? Yeah, me neither.",
	ANNOUNCE_NODAYSLEEP_CAVE = " Kinda too dark to sleep honestly.",
	ANNOUNCE_NOHUNGERSLEEP = "I could try to sleep, but my stomach demands for more berries right now.",
	ANNOUNCE_NOSLEEPONFIRE = "It's just the collapsing that concerns me.",
	ANNOUNCE_NODANGERSIESTA = "Let's take a nap after we finished killing whatever remains.",
	ANNOUNCE_NONIGHTSIESTA = "Cozy, but i'd rather not",
	ANNOUNCE_NONIGHTSIESTA_CAVE = "Maybe another time would do.",
	ANNOUNCE_NOHUNGERSIESTA = "I could try to take nap, after i filled my belly with yummy berries.",
	ANNOUNCE_NO_TRAP = "Haha gotcha sucker.",
	ANNOUNCE_PECKED = "Ouch! Bad birdy!",
	ANNOUNCE_QUAKE = "Oh boy, that cannot be a good sound",
	ANNOUNCE_RESEARCH = "I rember!",
	ANNOUNCE_SHELTER = "A shelter. Just what I need.",
	ANNOUNCE_THORNS = "Ouch!",
	ANNOUNCE_BURNT = "It's too hot for me!",
	ANNOUNCE_TORCH_OUT = "Aw my torch went off",
	...
	ANNOUNCE_WORMHOLE = "Not what i had in mind for an adventure",
	...
	ANNOUNCE_TOOL_SLIP = "Oopsie, i slipped",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "My berries are safe from thunder.",
	ANNOUNCE_TOADESCAPING = "Animal is running away!",
	ANNOUNCE_TOADESCAPED = "The animal is gone!",


	ANNOUNCE_DAMP = "I'm soaked.",
	ANNOUNCE_WET = "I might have to change clothes.",
	ANNOUNCE_WETTER = "Hmm, getting a bit uncomfortable.",
	ANNOUNCE_SOAKED = "I believe we are now drenched.",

	ANNOUNCE_WASHED_ASHORE = "Was i here before?",

    ANNOUNCE_DESPAWN = "Oh hi.",
	ANNOUNCE_BECOMEGHOST = "Oh hey! It's my body ! Wait, what?",
	ANNOUNCE_GHOSTDRAIN = "Ooh Spooky.",
	ANNOUNCE_PETRIFED_TREES = "Hey, why did all the trees go rocky?",
	ANNOUNCE_KLAUS_ENRAGE = "I do not know why it gets so angry.",
...
--fallback to speech_wilson.lua     },
    ...
    ANNOUNCE_ATTACH_BUFF_ELECTRICATTACK    = "Now i feel... Confident!",
    ANNOUNCE_ATTACH_BUFF_ATTACK            = "You wanna go?!",
    ANNOUNCE_ATTACH_BUFF_PLAYERABSORPTION  = "Time to end their lives",
    ANNOUNCE_ATTACH_BUFF_WORKEFFECTIVENESS = "Whoa i can gather my berries faster now?!",
    ANNOUNCE_ATTACH_BUFF_MOISTUREIMMUNITY  = "Ha! Take that, water!",
    ANNOUNCE_ATTACH_BUFF_SLEEPRESISTANCE   = "Who needs sleeps anyway ?",

    ANNOUNCE_DETACH_BUFF_ELECTRICATTACK    = "Eh, it was fun while it lasted.",
    ANNOUNCE_DETACH_BUFF_ATTACK            = "Nooo I still had more hunting I wanted to do!",
	...
	ANNOUNCE_OCEANFISHING_IDLE_QUOTE =
	{
		...
		"I could be getting so many berries right now.",
	},
...
--fallback to speech_wilson.lua 	ANNOUNCE_POCKETWATCH_OPEN_PORTAL_DIFFERENTSHARD = "only_used_by_wanda",
	...
	ANNOUNCE_TALK_TO_PLANTS =
	{
        ...
        "Feeling happy today?",
	    "Grow fast and let me devour you.",
        "Anything interesting going on lately? Right, nope. Because you're a plant.",
        "One, two, three, five? Wait, I lost count of how many were there.",
	},
	...
	BATTLECRY =
	{
		GENERIC = "Here i comeeee",
		PIG = "Take this you pig!",
		PREY = "I'm so sorry ~",
		SPIDER = "Come here little bug ~",
		SPIDER_WARRIOR = "Gimme your remains !",
		DEER = "No, don't run away!",
	},
	COMBAT_QUIT =
	{
		GENERIC = "Oh no, I'll let you go for now.",
		PIG = "Get back here, pork chop!",
		PREY = "I'll be back for more.",
		SPIDER = "Bleh. I'll get him later.",
		SPIDER_WARRIOR = "Not so tough now!",
	},

	DESCRIBE =
	{
		MULTIPLAYER_PORTAL = "Maybe i'll have lots of friends!",
        MULTIPLAYER_PORTAL_MOONROCK = "It's made of some kind of rock from the moon",
        MOONROCKIDOL = "Looks creepy, eh.",
        CONSTRUCTION_PLANS = "Can i build this?",
        ...
        ANTLIONTRINKET = "I guess i'll just give it away then.",
        SANDSPIKE = "Die!",
        SANDBLOCK = "Perish!",
        GLASSSPIKE = "I can't believe that worked!",
        GLASSBLOCK = "See? Killing solves everything.",
        ABIGAIL_FLOWER =
        {
        ...
        BOOK_BIRDS = "Interesting book with a lot of bird drawings.",
        BOOK_TENTACLES = "Looks like kindling to me!",
        BOOK_GARDENING = "Any tips to grow more berries?",
		BOOK_SILVICULTURE = "Hey, it's a book about kindling!",
		BOOK_HORTICULTURE = "Any tips to grow more berries?",
        BOOK_SLEEP = "Bo-oring!",
        BOOK_BRIMSTONE = "Woah! It feels warm.",

        PLAYER =
        {
            GENERIC = "Oh hi, %s!",
            ATTACKER = "I dunno, %s... you are kinda sus.",
            MURDERER = "Kill them!",
            REVIVER = "Oh, did you die, %s?",
            GHOST = "Hold on, lets me get you a heart, %s.",
            FIRESTARTER = "Stop burning thing!",
        },
        WILSON =
        {
            GENERIC = "Hi %s!",
        ...
        GURA =
        {
            GENERIC = "Howdy %s, little Sharky!",
            ATTACKER = "I'll get you %s, you stinky!",
            MURDERER = "Come here %s! I'm not afraid of you!",
            REVIVER = "Gura you freed me from my eternal wandering!",
            GHOST = "Hold on Gura, lemme get fix you up real quick",
            FIRESTARTER = "Come on Gura! Don't just burn things around us!",
        },
	    CALLIOPE_MORI  =
        {
            GENERIC = "Hello Calli! You probably won't take me away, right?",
            ATTACKER = "Do it Calli, you coward!",
            MURDERER = "I think I saw Calli reaped someone. Better avoid her.",
            REVIVER = "Calli you saved me? You won't get a pay cut right?",
            GHOST = "How is this possible, Calli?",
            FIRESTARTER = "Oh no I think Calli is drunk again!",
        },
	    KIARA =
        {
            GENERIC = "Hi there Kiara, fellow avian friend!",
            ATTACKER = "Try to revive from this Kiara!",
            MURDERER = "Burn the chicken!",
            REVIVER = "Now I'm the phoenix! Hehe!",
            GHOST = "Hey Kiara, I thought you can revive from ashes?",
            FIRESTARTER = "Hey stop it! I'll tell the reaper about this!",
        },
        NINOMAE =
        {
            GENERIC = "Hello Ina, grand priestess of the ancient gods!",
            ATTACKER = "Your followers can't protect you forever, Ina!",
            MURDERER = "Ina! I knew you couldn't be trusted!",
            REVIVER = "Is this one of your grand priestess skills Ina?",
            GHOST = "Have a heart, Ina! Heh heh.",
            FIRESTARTER = "I knew you had it in you, Ina!",
        },
        AMELIA =
        {
            GENERIC = "Good day Watson. Which timeline did you come from this time?",
            ATTACKER = "I'm not afraid of your tactics, Watson!",
            MURDERER = "Guess traveling through time finally took a toll on you, Watson...",
            REVIVER = "My death is just in the past now, right Watson?",
            GHOST = "Time has finally caught Watson. Oof.",
            FIRESTARTER = "Are we lighting fires?! I want in!",
        },
        NANASHI_MUMEI =
        {
            GENERIC = "Hey! That's my face! Give it back!",
            ATTACKER = "You're no match for me! Oh wait, you are.",
            MURDERER = "Murderer! Burn the impostor!",
            REVIVER = "From one guardian to another guardian!",
            GHOST = "Is that really what my hair looks like?",
            FIRESTARTER = "Berries lovers! High five.",
        },
        IRYS =
        {
            GENERIC = "Hey there IRyS! may I share this soda with you?",
            ATTACKER = "I've never seen you so, uh, passionate...",
            MURDERER = "Hope has descended and she's coming for us, ahhhh!",
            REVIVER = "I'll never lose hope now!",
            GHOST = "Not looking well, IRyS?",
            FIRESTARTER = "IRyS! Was that your fire? I'm so proud!",
        },
...
--fallback to speech_wilson.lua         },
        GLOMMER =
        {
            ...
            SLEEPING = "It is much more cute when it doesn't make any noises.",
        },
        GLOMMERFLOWER =
        {
            GENERIC = "Why does everything have to be a flower?!",
            DEAD = "I wonder how it taste like...",
        },
		...
		WORMLIGHT = "Shiny berries!",
		WORMLIGHT_LESSER = "Shiny little berries!",
		WORM =
		{
		    PLANT = "Shiny berries!",
		...
		EEL_COOKED = "Now it cannot look at me anymore hehe.",
		UNAGI = "You can make it fancy but it's still an eel.",
		EYETURRET = "I wish it grew legs.",
		...
		GREENSTAFF = "It won't be much but I guess it's still useful.",
		GIFT = "It's for me right?!",
        GIFTWRAP = "A paper for hiding thing.",
		POTTEDFERN = "Nice decorative plants.",
...
--fallback to speech_wilson.lua 			WEREBEAVER = "only_used_by_woodie", --woodie specific
		...
		THULECITE = "I don't think it is breakable that easily.",
		...
		NIGHTMARE_TIMEPIECE =
		{
            ...
            WARN = "I can feel something's about to go cookoo.",
            WAXING = "Oh hey nightmare ...thingy. Whoa that's a lot",
            STEADY = "It's almost humming.",
            WANING = "I think it's about to be over.",
            DAWN = "I guess it's nearly ended.",
            NOMAGIC = "I don't think it's working.",
		},
		BISHOP_NIGHTMARE = "Ahhh!",
		ROOK_NIGHTMARE = "It has a lovely smile.",
		KNIGHT_NIGHTMARE = "It looks pretty worn down.",
		MINOTAUR = "Poor thing. Trapped in this dark labyrinth.",
		SPIDER_DROPPER = "They come from above. Don't get near them.",
		NIGHTMARELIGHT = "Light without fire is just .... whack.",
		...
		SLURPER = "Do they have little berries in their bellies?",
		SLURPER_PELT = "Eeewwwww, it's still alive!",
		ARMORSLURPER = "Oh, ick! Ick! Ick! Ick! Eeeeeewwwwww!",
		ORANGEAMULET = "It picks up stuff, neat!",
        ...
        OPALPRECIOUSGEM = "It's small and shiny, just like me !",
        TELEBASE =
		{
		...
		CAVE_BANANA_TREE = "Why are they here?",
        ...
        BATCAVE = "Hello? Anybody home ?",
        BEDROLL_FURRY = "It's too frilly.",
        BUNNYMAN = "Funny white animal.",
        FLOWER_CAVE = "It's burning inside.",
        GUANO = "It stinks.",
        LANTERN = "Light the way for me and my friends.",
        ...
        MUSHROOM_LIGHT =
        {
            ...
            OFF = "This mushroom's not lighting up.",
        ...
        RABBITHOUSE =
        {
            ...
            BURNT = "Ha! Stay away from my garden!",
        },
        SLURTLE = "I want to blow it up!",
        SLURTLE_SHELLPIECES = "Heh. It broke.",
        SLURTLEHAT = "It's perfectly head-shaped.",
        SLURTLEHOLE = "They come out from this? I better smash it",
        SLURTLESLIME = "I hate this stuff. Too slimy",
        SNURTLE = "Kaboom!",
        SPIDER_HIDER = "I'm gonna kill you!",
		...
		TURF_DRAGONFLY = "That's a huge monster.",

        TURF_SHELLBEACH = "The ground is boring.",

		POWCAKE = "Perfect bait for my preys.",
       	...
       	CAVE_ENTRANCE_OPEN =
        {
            ...
            OPEN = "I hope there's berries down there somewhere.",
		...
		ARMORGRASS = "A waste of grass .Lol",
		ARMORMARBLE = "Seems kinda heavy, but it'll certainly stop me from being killed.",
		ARMORWOOD = "Now I can take on the world!",
		ARMOR_SANITY = "Like being wrapped in my friend's warm embrace.",
		ASH =
		{
		...
		BACKPACK = "Great for carrying more berries, woooo",
		BACONEGGS = "Haven't got bacon this good in ages!",
		BANDAGE = "Hold on, lets me patch you up.",
		...
		BEEBOX =
		{
			READY = "Yay! Let's get some honey!",
			FULLHONEY = "Yay! Let's steal all the honey!",
		...
		MUSHROOM_FARM =
		{
			STUFFED = "Ooh they are bursting out !",
			LOTS = "Plenty of mushrooms to harvest !",
			SOME = "There's mushrooms growing in it now.",
			EMPTY = "It's just a weird log now .",
			ROTTEN = "Nasty. Don't want that to get anywhere near my mouth",
		...
		BEEFALO =
		{
			...
			GENERIC = "You look funny, can i be your friend ?",
			NAKED = "Ha! you're all naked now!",
			SLEEPING = "Oh my god they are so cuteee!",
            --Domesticated states:
		...
		BERRIES = "Here, take some berries!",
		BERRIES_COOKED = "Roasted berries!",
        BERRIES_JUICY = "You want more berries?",
        BERRIES_JUICY_COOKED = "Delicious berries!",
		BERRYBUSH =
		{
			BARREN = "I need it to produce more berries.",
			WITHERED = "No berries? What a sad season.",
			GENERIC = "Mmmmm. Berries.",
			PICKED = "But I want more berries!",
			DISEASED = "Burn the sick!",--removed
			DISEASING = "Blech. You smell.",--removed
			BURNING = "No! My berries!",
		},
		BERRYBUSH_JUICY =
		{
			BARREN = "It needs some plant food!",
			WITHERED = "Maybe I should try to plant it inside cave.",
			GENERIC = "Delicious berries!",
			PICKED = "Where can I get more?",
			DISEASED = "Burn the sick!",--removed
			DISEASING = "Blech. You smell.",--removed
			BURNING = "Don't let the berries burn!",
		},
		...
		BLOWDART_FIRE = "Put those animals on fire.",
		BLOWDART_SLEEP = "Put those animals to sleep.",
		BLOWDART_PIPE = "Nice ranged weapon to have.",
		BLOWDART_YELLOW = "This could make them feel numb.",
		BLUEAMULET = "Frozen to the touch.",
		BLUEGEM = "This feels oddly chilly.",
		BLUEPRINT =
		{
            COMMON = "This will save some remembering.",
            RARE = "Woah, lucky me!",
        },
		...
		BLUE_MUSHROOM =
		{
			GENERIC = "Ohh, a mushroom.",
			INGROUND = "Hey! You! Get up here!",
			PICKED = "Maybe it will return some day.",
		},
		BOARDS = "Boards. They're useful for building stuffs",
		BONESHARD = "Most of them are the remains of creatures we met, including me.",
		BONESTEW = "A big pot of stew? My stomach is grumbling already!",
		BUGNET = "I wanna catch those pretty butterflies.",
		BUSHHAT = "Berry hat!",
		BUTTER = "Tasty.I could make berry pies with this",
		BUTTERFLY =
		{
			GENERIC = "So beautiful! Can i have them ?",
		...
		CACTUS =
		{
			GENERIC = "That's not a berry bush.",
		...
		COLDFIRE =
		{
			...
			GENERIC = "Cozy and warm. Feels just like home",
			HIGH = "Now this is overkill",
			LOW = "This small ember fills me with hope",
			NORMAL = "Youch! I almost burnt my feathers !",
		...
		CAMPFIRE =
		{
			...
			LOW = "This small ember fills me with hope",
			NORMAL = "Youch! I almost burnt my feathers !",
			OUT = "Awww. It's all gone.",
		},
		CANE = "It's way easier to run around with this handy stick.",
		CATCOON = "Here, kitty kitty!",
		CATCOONDEN =
		{
			GENERIC = "Do you think there's more in there ?",
			EMPTY = "Nobody's home.I'm gonna miss them",
		},
		...
		CUTGRASS = "Tying things up nicely.",
		CUTREEDS = "They seems to be fitting to make papers.",
		...
		EYEBRELLAHAT =	"I've always wanted to wear an eyeball over my head.",
		DEPLETED_GRASS =
		{
...
--fallback to speech_wilson.lua 		DEVTOOL_NODEV = "I'm not strong enough to wield it.",
		...
		DRAGONFLY = "Looks nasty.. and it's flying.",
		ARMORDRAGONFLY = "This might be too hot for me.",
		DRAGON_SCALES = "That's kinda cool looking scales.",
		DRAGONFLYCHEST = "Oh, it drops a chest.",
		DRAGONFLYFURNACE =
		{
		...
		LAVA_POND = "Too hot!",
		LAVAE = "Weird fiery animal.",
		LAVAE_COCOON = "Weird fiery animal baby.",
		LAVAE_PET =
		{
			STARVING = "I can see her ribs!",
			HUNGRY = "I think she wants some fuel.",
			CONTENT = "It's look happy.",
			GENERIC = "a fiery pet animal.",
		},
		LAVAE_EGG =
		{
		...
		DRAGONFRUIT = "Not as good as berries but a delightful treat to have anyways",
		DRAGONFRUIT_COOKED = "Pretty tasty !",
		DRAGONFRUIT_SEEDS = "Some seeds.",
		DRAGONPIE = "This looks so delicious !",
		DRUMSTICK = "Ohhh, chicken meat.",
		DRUMSTICK_COOKED = "Hmm... tasty.",
		DUG_BERRYBUSH = "I'm gonna plant this everywhere.",
		DUG_BERRYBUSH_JUICY = "This is a rare one. Keep it somewhere safe.",
		...
		ENDTABLE =
		{
			...
			GENERIC = "That's a weird looking table .",
		...
		DECIDUOUSTREE =
		{
			BURNING = "This is too bright for my eyes!",
			BURNT = "What a waste of good tree.",
			CHOPPED = "We gonna need to replant it soon.",
			POISON = "Not this stupid tree again.",
			GENERIC = "We might need some logs.",
		},
		...
		EYEPLANT = "What an intersting looking plant.",
		INSPECTSELF = "Why didn't anyone tell me I had ashes on my face?",
		FARMPLOT =
		{
			GENERIC = "Can I plant berry bush here?",
			GROWING = "Not a berry? That's too bad.",
			NEEDSFERTILIZER = "Hold on, I will get some fertilizer.",
			BURNT = "Not again.",
		},
		...
		FEATHERPENCIL = "Now I can write some records.",
        COOKBOOK = "Let's see, what should I cook today?",
		...
		FIREPIT =
		{
			...
			HIGH = "Ooh so hot ",
			LOW = "Cozy and warm. Reminds me of someone",
			NORMAL = "Burn!",
		...
		COLDFIREPIT =
		{
			...
			HIGH = "Brrrr it's giving me a cold shoulder ",
			LOW = "Cold fire sounds impossible, but hey it is a thing.",
			NORMAL = "Burn!",
			OUT = "Make the fire come back!",
		},
		FIRESTAFF = "This looks fun to play with.",
		FIRESUPPRESSOR =
		{
			ON = "Useful for containing random burnables.",
			OFF = "We'll get you back sometime. Rest for now.",
			LOWFUEL = "Almost out.",
		},

		FISH = "A fish!",
		FISHINGROD = "I'll do some fishing.",
		FISHSTICKS = "Sticks of fish.",
		FISHTACOS = "Convenient taco-grip.",
		FISH_COOKED = "Tasty seafood.",
		FLINT = "This was how human starts their civilization.",
		FLOWER =
		{
            GENERIC = "Flowers!",
            ROSE = "Red thorny flower!",
        },
        FLOWER_WITHERED = "That looks sad.",
		FLOWERHAT = "Flower hat!",
		FLOWER_EVIL = "Those flowers look weird.",
		FOLIAGE = "Fuel for the fire.",
		FOOTBALLHAT = "Animal skin hat.",
		...
		GOLDENAXE = "This remind me Suisei-senpai.",
		GOLDENPICKAXE = "Shiny pointy axe.",
		GOLDENPITCHFORK = "Shiny pitchfork.",
		GOLDENSHOVEL = "Shiny digging tool.",
		GOLDNUGGET = "Oh hey, I found shiny.",
		GRASS =
		{
		...
		GRASSGEKKO =
		{
			GENERIC = "Grass animal?",
			DISEASED = "Double ew!", --unimplemented
		},
		GREEN_CAP = "Boring!",
		GREEN_CAP_COOKED = "I think it is safe to be consumed now.",
		GREEN_MUSHROOM =
		{
			GENERIC = "Weird mushroom.",
			INGROUND = "Hey! You! Get up here!",
			PICKED = "Maybe it will return some day.",
		},
		...
		HEALINGSALVE = "Come here, I will heal you.",
		HEATROCK =
		{
			FROZEN = "Frozen solid.",
			COLD = "It's stone cold.",
			GENERIC = "An essential traveling tool.",
			WARM = "Still warm enough.",
			HOT = "It's look really hot!",
		},
		HOME = "Nice and cozy.",
		HOMESIGN =
		{
			GENERIC = "Great, now I won't get lost.",
            UNWRITTEN = "Write the direction down so I don't forget.",
			BURNT = "Oh no!",
		},
		ARROWSIGN_POST =
		{
		...
		HONEYNUGGETS = "Honey-covered cooked morsels.",
		...
		HOUNDBONE = "Gross.",
		HOUNDMOUND = "I have no business here.",
		ICEBOX = "A civilized food storage.",
		...
		LOG =
		{
			BURNING = "Oh no, it's burning!",
			GENERIC = "I could use some woods.",
		},
		LUCY = "We could be good friends, you and I.",
		LUREPLANT = "There were eyes all around it.",
        ...
        MAPSCROLL = "Nothing's on it? Might as well draw a new one then.",
        MARBLE = "It's heavy!",
        MARBLEBEAN = "I guess we just... plant it? In the dirt?",
        MARBLEBEAN_SAPLING = "That makes no sense!",
        MARBLESHRUB = "The bush is taking some time to grow.",
        MARBLEPILLAR = "I wonder if this could be useful to me.",
        MARBLETREE = "It finally grew.",
        MARSH_BUSH =
        {
        ...
        MEAT = "I prefer berries, but this also tasty.",
        ...
        MERMHEAD =
        {
            GENERIC = "Haha! Fish stick.",
            BURNT = "Double whammy!",
        },
        MERMHOUSE =
        {
            GENERIC = "Even merms can build a house.",
            BURNT = "Now it's gone.",
        },
        MINERHAT = "Let's go excavate what i have forgoten.",
        MONKEY = "Joke's on you! I'll have all the bananas i want.",
        MONKEYBARREL = "What a wonderfully funky home.",
        MONSTERLASAGNA = "Noodles, meat and clumps of hair. Nasty.",
        FLOWERSALAD = "Flower. Flower... Flower ?",
        ICECREAM = "Brain Freeze. Brrrrr",
        WATERMELONICLE = "Melon on a stick. Perfect for a summer treat",
        TRAILMIX = "Crunchy and Kwispy.",
        HOTCHILI = "I need water, ahhhh!",
        ...
        PANFLUTE = "Music to my ears.",
        PAPYRUS = "Now I got something to write.",
        WAXPAPER = "Eh, I don't think I can write on that.",
        PENGUIN = "Funny looking swimming bird.",
        PERD = "Darn it! Don't touch my berries!",
        PEROGIES = "Tasty things, sealed with fire.",
        PETALS = "Ohhh, flower.",
        PETALS_EVIL = "Edgy flower.",
        PHLEGM = "Gross!.",
        PICKAXE = "Its sharpness is on the point.",
        PIGGYBACK = "It's a backpack made out of animal skin.",
        PIGHEAD =
        {
        ...
        PIGHOUSE =
        {
            ...
            GENERIC = "I guess this is another form of civilization.",
            LIGHTSOUT = "Can you let me in, please?",
            BURNT = "Now it's gone.",
        },
        ...
        PLANTMEAT_COOKED = "Fire was the best thing civilization had discovered.",
        PLANT_NORMAL =
        {
        ...
        POMEGRANATE_COOKED = "Sweet and tasty.",
        ...
        PUMPKIN = "I'd like to carve faces on to them one day.",
        ...
        RABBIT =
        {
            GENERIC = "He looks fluffy.",
            HELD = "I have him right where I want him!",
        },
        RABBITHOLE =
        {
            GENERIC = "Hey rabbits! Come out so I can give you some berries.",
            SPRING = "Poor rabbits must be stuck down there.",
        },
        RAINOMETER =
        {
            GENERIC = "This could probably tell us how wet we're gonna get.",
        ...
        RED_CAP_COOKED = "Why did i do that again ?",
        RED_MUSHROOM =
        {
            GENERIC = "Pretty!",
            INGROUND = "Hey! You! Get up here!",
        ...
        RESEARCHLAB =
        {
            GENERIC = "In case I forgor things... again.",
            BURNT = "There's no rember from that now.",
        },
        RESEARCHLAB2 =
        {
            GENERIC = "In case I forgor things... again.",
        ...
        PETRIFIED_TREE = "Trees turning to rocks is actually a thing ?",
        ROCK_PETRIFIED_TREE = "I guess i forgor how nature works.",
        ROCK_PETRIFIED_TREE_OLD = "I guess i forgor how nature works.",
        ROCK_ICE =
        {
            GENERIC = "Cold and wet.",
            MELTED = "I think i saw that coming.",
        },
		...
		SEEDS = "Farming is quite enjoyable, especially when you put your mind into it.",
		SEEDS_COOKED = "No good for farming now.",
		SEWING_KIT = "I can patch up my worn clothes with this!",
		SEWING_TAPE = "At least something around here can hold it together.",
		SHOVEL = "I wonder if this will make me a knight one day.",
		SILK = "Mmmmmm. Smooth.",
		...
		SPEAR = "That looks good for some hunting'!",
		...
		STINGER = "It's pokey!",
		STRAWHAT = "A hat made of straw. Not too fashionable but it'd do.",
		...
		HAWAIIANSHIRT = "This makes me wanna go take a dip.",
		TAFFY = "Sugary things burn great, but best not waste food.",
		TALLBIRD = "I don't think it wants to be friends.",
		TALLBIRDEGG = "Will keeping it warm help?",
		TALLBIRDEGG_COOKED = "A little bit heat makes them so much better.",
		TALLBIRDEGG_CRACKED =
		{
		...
		WARDROBE =
		{
			GENERIC = "Don't look while I'm changing. It's emberrysing!",
            BURNING = "Oh no!",
			BURNT = "We need to replace the whole wardrobe.",
		},
		WARG = "You're a big mean jerk!",
		WASPHIVE = "A cone full of jerks.",
		WATERBALLOON = "Boo! Hissss!",
		WATERMELON = "Perfect snack for hot days",
		WATERMELON_COOKED = "Seems wrong but hey, as long as it works.",
		WATERMELONHAT = "Well, this reminds me of a certain somebody who did nothing wrong.",
		WAXWELLJOURNAL = "Would make a great bedtime story... for nightmares!",
		WETGOOP = "How did it go wrong?! I had the recipes right and everything...",
        WHIP = "I wouldn't mind using this.",
		...
		WORMHOLE =
		{
			GENERIC = "Doorway to another land full of wonders.",
			OPEN = "Will it bite?",
		},
		...
		ICESTAFF = "Haha ice blasts goes pew pew.",
		REVIVER = "I expected it to be blacker.",
		SHADOWHEART = "It is still beating ?!",
        ATRIUM_RUBBLE =
        {
...
--fallback to speech_wilson.lua         QUAGMIRE_CRATE = "Kitchen stuff.",
        ...
        MAST = "I can see the world from here, if i'm allowed to climb on it.",
        ...
        STEERINGWHEEL = "Spinning it seems fun!!",
        ANCHOR = "Dropping it is a lot more fun than pulling it back up.",
        BOATPATCH = "Fixing stuff is quite a hassle, but necessary.",
        DRIFTWOOD_TREE =
        {
            BURNING = "YES!",
		...
		KELP = "Salty and um ... not that good, to be honest",
		KELP_COOKED = "It does smells better, still taste like seawater anyways.",
		...
		COOKIECUTTERHAT = "Funny looking hat that hurts who ever touches it.",
		SALTSTACK =
		{
		...
		CALIFORNIAROLL = "Sushi !",
		SEAFOODGUMBO = "All that hard work for a nice bowl of stew.",
		SURFNTURF = "Surfs up!",
		...
		TRIDENT = "I can feel a storm approaching.",
...
--fallback to speech_wilson.lua         WORTOX_SOUL = "only_used_by_wortox", --only wortox can inspect souls
        ...
        POTATOTORNADO = "Twisting Fries !",
        DRAGONCHILISALAD = "I can't wait to eat it.",
        GLOWBERRYMOUSSE = "That's my kind of dessert.",
        ...
        POTATO = "Poe-tay-toe ? Why do i have an urge to call it Poh-tah-toe instead?",
        POTATO_COOKED = "Potato!",
        POTATO_SEEDS = "It's just a bunch of seeds.",

        TOMATO = "Ughh... I don't like this very much.",
        TOMATO_COOKED = "It's uncomfortable to think about this.",
		...
		MESSAGEBOTTLE = "Messages from friends over the world!",
		MESSAGEBOTTLEEMPTY = "I should write something back for them.",
        ...
        DUSTMOTH = "They just clean all day? Sounds like somebody i know.",

        DUSTMOTHDEN = "It's impossible to break. Not that I tried or anything.",

        ARCHIVE_LOCKBOX = "Great. We turned on the mysterious thing and got another mysterious thing.",
        ARCHIVE_CENTIPEDE = "Giant machine bug!",
        ...
        WATERINGCAN =
        {
            GENERIC = "Gotta give my berry some waters.",
            EMPTY = "Better fill it up.",
        },
        PREMIUMWATERINGCAN =
        {
            GENERIC = "Ha. It wasn't even THAT useful afterall.",
		...
		GOLDEN_FARM_HOE = "It won't help berries grow, but at least it's shiny.",
		...
		FORGETMELOTS = "Flower,flower ...It's more funny when she said it.",
        ...
        CARROT_OVERSIZED = "Woah, that's one big carrot!",
        CORN_OVERSIZED = "Let's make popcorn !",
        ...
        TOMATO_OVERSIZED = "Ugh, someone would want to bite the tip and squeeze off of it...",
        POTATO_OVERSIZED = "Let's roast it!",
		...
		FARM_PLANT =
		{
			...
			ROTTEN = "Yeah... I'm not putting that in stomach.",
        ...
        MOONSTORM_GLASS = {
            ...
            INFUSED = "It's sparkles with electricity!"
        },
...
--fallback to speech_wilson.lua 			DEPLETED = "only_used_by_wanda",
        ...
        FIG = "Not as tasty as berries. Never!",
        ...
        GRASSGATOR = "It needs a bit trim.",
        ...
        DUMBBELL = "Do not play catch with these unless you want to forgor stuffs.",
		...
		EYEMASKHAT = "Well, looks better than nothing.",
