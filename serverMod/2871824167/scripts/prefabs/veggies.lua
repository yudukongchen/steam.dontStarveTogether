...
local function oversized_makeloots(inst, name)
    ...
    return {product, product, seeds, seeds,product, product, seeds, seeds,product, product, seeds, seeds,product, product, seeds, seeds,product, product, seeds, seeds,product, product, seeds, seeds,product, product, seeds, seeds,product, product, seeds, seeds,product, product, seeds, seeds,product, product, seeds, seeds,product, product, seeds, seeds, math.random() < 1 and product or seeds}
end
