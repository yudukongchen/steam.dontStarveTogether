return
{
	ACTIONFAIL =
	{
        ...
        BUILD =
        {
			...
			TICOON = "我对自己的大虎专一投入，眼里根本没别人。",		--暂无注释
        },
		SHAVE =
		{
            ...
            SOMEONEELSESBEEFALO = "我才不薅别人家皮弗娄牛的毛！",		--给别人的牛刮毛
		},
		STORE =
		{
			GENERIC = "装满了。",		--存放东西失败
            ...
            NOTMASTERCHEF = "烹饪水平还不够。",		--非厨师尝试往便携锅里塞东西
		},
        CONSTRUCT =
        {
            INUSE = "有人抢先了。",		--建筑正在使用
		...
		RUMMAGE =
		{
            ...
            NOTMASTERCHEF = "烹饪水平还不够。",		--非厨师尝试打开便携锅
		},
		UNLOCK =
        {
        	WRONGKEY = "我做不到。",		--暂无注释
		...
		OPEN_CRAFTING =
		{
            PROFESSIONALCHEF = "烹饪水平还不够。",		--暂无注释
			SHADOWMAGIC = "那可不是科学。",		--暂无注释
		},
        COOK =
        {
		...
		DISMANTLE =
		{
			COOKING = "煮着东西呢，不能这样。",		--拆便携的物品-正在做饭
			INUSE = "科学告诉我，我该等轮到我。",		--拆便携的物品-正在使用
			NOTEMPTY = "我得先把里面的东西弄走。",		--拆便携的物品-里面有物品
        },
        FISH_OCEAN =
		{
			TOODEEP = "不是海钓竿，不适合深海海钓。",		--拿普通鱼竿去深海钓鱼
		},
        OCEAN_FISHING_POND =
		{
			WRONGGEAR = "这根钓竿不适合在池塘钓鱼。",		--拿深海鱼竿去普通的池子里钓鱼
		},
        READ =
        {
        ...
        CHANGEIN =
        {
            ...
            NOTENOUGHHAIR = "皮毛不够用来装扮。",		--给牛换装 牛毛被刮光了
            NOOCCUPANT = "得在上面栓点东西。",		--给牛换装 没牛？
        },
        ATTUNE =
        {
        ...
        MOUNT =
        {
            TARGETINCOMBAT = "我还没笨到去惹一头愤怒的皮弗娄牛！",		--骑乘，牛正在战斗
        ...
        USEITEMON =
        {
            BEEF_BELL_INVALID_TARGET = "我不可能做到！",		--对无效目标使用牛铃铛
    ...
    ANNOUNCE_SNARED_IVY = "救命啊！花园正在反击!",		--被针刺旋花攻击
    ...
    ANNOUNCE_ATTACH_BUFF_ELECTRICATTACK    = "我带的是正电！",		--获得电击buff
    ANNOUNCE_ATTACH_BUFF_ATTACK            = "动手打！",		--获得攻击加强的buff(目前是指辣椒粉料理)
    ANNOUNCE_ATTACH_BUFF_PLAYERABSORPTION  = "我现在感觉安全多了！",		--获得防御加强的buff(目前是指大蒜粉料理)
    ANNOUNCE_ATTACH_BUFF_WORKEFFECTIVENESS = "生产力提高！",		--获得工作效率加强的buff(目前是指蜂蜜粉料理)
    ANNOUNCE_ATTACH_BUFF_MOISTUREIMMUNITY  = "干的像薇克巴顿的讲义！",		--获得潮湿免疫的buff(目前是指蓝带鱼排)
    ANNOUNCE_ATTACH_BUFF_SLEEPRESISTANCE   = "顿时觉得神清气爽，再也不累了！",		--获得睡眠减缓的buff(目前是指月蘑菇料理)
    ANNOUNCE_DETACH_BUFF_ELECTRICATTACK    = "电没了，但是还残存静电。",		--失去电击buff
    ANNOUNCE_DETACH_BUFF_ATTACK            = "肌肉紧实的感觉很快就消失了。",		--失去攻击加强的buff(目前是指辣椒粉料理)
    ANNOUNCE_DETACH_BUFF_PLAYERABSORPTION  = "虽然时间不长，但是还不错。",		--失去防御加强的buff(目前是指大蒜粉料理)
    ANNOUNCE_DETACH_BUFF_WORKEFFECTIVENESS = "拖延症又回来了...",		--失去工作效率加强的buff(目前是指蜂蜜粉料理)
    ANNOUNCE_DETACH_BUFF_MOISTUREIMMUNITY  = "我的干旱期结束了。",		--失去潮湿免疫的buff(目前是指蓝带鱼排)
    ANNOUNCE_DETACH_BUFF_SLEEPRESISTANCE   = "我……（哈欠）再也……不累了……",		--失去睡眠减缓的buff(目前是指月蘑菇料理)
	ANNOUNCE_OCEANFISHING_LINESNAP = "所有辛苦，都被折断。",		--海钓 线崩断了
	ANNOUNCE_OCEANFISHING_LINETOOLOOSE = "收线也许管用。",		--海钓失败 渔具丢失
	ANNOUNCE_OCEANFISHING_GOTAWAY = "它逃走了。",		--海钓 鱼跑远了
	ANNOUNCE_OCEANFISHING_BADCAST = "甩竿技术有待提高……",		--海钓 抛竿扔地面上去了
	ANNOUNCE_OCEANFISHING_IDLE_QUOTE =
	{
		"鱼呢？",		--海钓 没上钩的时候闲聊
		"也许该换个鱼多的地方钓。",		--海钓 没上钩的时候闲聊
		"我还以为海里到处都是鱼呢！",		--海钓 没上钩的时候闲聊
		"我现在明明可以做更科学的事情……",		--海钓 没上钩的时候闲聊
	},
    ...
    ANNOUNCE_CARRAT_ERROR_WRONG_WAY =
	{
        ...
        "掉头，你什么眼神啊！",		--胡萝卜鼠比赛 跑错方向
    },
    ANNOUNCE_CARRAT_ERROR_FELL_ASLEEP = "你敢给我睡！起来，我们要赢比赛！",		--起床了，蠢胡萝卜鼠！
	...
	ANNOUNCE_FIRENETTLE_TOXIN_DONE = "写给自己的笔记：不要再用火荨麻毒素进行试验。",		--烈火荨麻 buff结束
	ANNOUNCE_TALK_TO_PLANTS =
	{
        "生长吧，植物，生长吧！",		--和植物聊天
        "我一直想要一株像你这样的植物。",		--和植物聊天
		"你好，植物，我来给你提供每日的社交剂量了！",		--和植物聊天
        "你真是一株好植物啊。",		--和植物聊天
        "植物，你真是一个好的聆听者。",		--和植物聊天
	},
	...
	DESCRIBE =
	{
		...
		BOOK_HORTICULTURE = "读了半天没看到一个农场。",		-- 物品名:"园艺学简编版" 制造描述:"讲述培育和照料植物的相关知识。"
        ...
        BATWING_COOKED = "至少它不会再活过来了。",		-- 物品名:"熟蝙蝠翅膀"
		...
		ARMOR_SANITY = "穿着我虽然安全了，心里确不踏实。",		-- 物品名:"暗夜甲" 制造描述:"保护你的躯体，但无法保护你的心智。"
		ASH =
		{
		...
		BEARDHAIR = "当它们不是你自己的时候才会恶心。",		-- 物品名:"胡须"
		BEARGER = "熊一样大的獾。",		-- 物品名:"熊獾"
		BEARGERVEST = "欢迎来到冬眠站！",		-- 物品名:"熊皮背心" 制造描述:"像熊一样的背心。"
		...
		COOKINGRECIPECARD = 
		{
			GENERIC = "科学帮帮我吧，我实在破译不了这些笔迹。",		-- 物品名:"{item}食谱卡"->默认
		},
        ...
        HERMITHOUSE =
	{
        ...
        ARCHIVE_RESONATOR =
	{
            GENERIC = "能用一个超级负责的机器，谁还要用地图？",		-- 物品名:"星象探测仪"->默认
            IDLE = "它似乎找到了值得被找到的东西。",		-- 物品名:"星象探测仪"
        },
        ARCHIVE_RESONATOR_ITEM = "啊哈！我运用秘密知识建造了一个设备！为什么这种感觉似曾相识呢……",		-- 物品名:"星象探测仪" 制造描述:"它会出土什么秘密呢？"
        ...
        ARCHIVE_PORTAL =
	{
		...
		CARNIVALGAME_SHOOTING_STATION =
		{
			...
			PLAYING = "我可以算出弹道，但这涉及到很多复杂的数字和演算。",		-- 物品名:"保卫鸟巢"
		},
		...
		CARNIVALGAME_SHOOTING_BUTTON =
		{
			...
			PLAYING = "科学迫使我按下那个闪亮的大按钮！",		-- 物品名:"按钮"
		},
        ...
        OCEAN_TRAWLER =
	{
        ...
        STAGEUSHER =
        {
            STANDING = "总之不要伸出你的手，好吗？",		-- 物品名:"多刺舞台"
            SITTING = "这里有些古怪，但我说不出所以然。",		-- 物品名:"多刺舞台"
        },
        SEWING_MANNEQUIN =
        {
        ...
        YOTR_FIGHTRING_KIT = "它一定是为了科学而建造的！",		-- 物品名:"枕头大战坑套装"
        YOTR_FIGHTRING_BELL =
        {
        ...
        YOTR_DECOR_2 =
	{
		...
		SHOVEL_LUNARPLANT = "分离泥土的概率会变得无穷大！",		-- 物品名:"亮茄锄铲" 制造描述:"铲子和园艺锄之间交叉授粉的突破性成果。"
		...
		SHADOWTHRALL_WINGS = "翅膀已经准备好了登场。",		-- 物品名:"墨荒"
