...
local assets =
{
	...
	Asset("ATLAS", "images/inventoryimages/yifufy.xml"), --加载物品栏贴图
    Asset("IMAGE", "images/inventoryimages/yifufy.tex"),
}
...
local function fn()
	...
	inst.components.inventoryitem.atlasname = "images/inventoryimages/yifufy.xml"  --加载物品栏贴图 mod物品必须有
    ...
    inst.components.waterproofer:SetEffectiveness(0.8) --防雨

    inst:AddComponent("insulator")
    inst.components.insulator:SetInsulation(TUNING.INSULATION_SMALL)  --保暖
...
return Prefab("yifufy", fn, assets) --生成这个预设物  代码为 yifu
