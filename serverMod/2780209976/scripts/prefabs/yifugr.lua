...
local assets =
{
	...
	Asset("ATLAS", "images/inventoryimages/yifugr.xml"), --加载物品栏贴图
    Asset("IMAGE", "images/inventoryimages/yifugr.tex"),
}
...
local function fn()
	...
	inst.components.inventoryitem.atlasname = "images/inventoryimages/yifugr.xml"  --加载物品栏贴图 mod物品必须有
...
return Prefab("yifugr", fn, assets) --生成这个预设物  代码为 yifu
