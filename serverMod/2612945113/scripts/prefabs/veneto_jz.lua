local assets =
{
    Asset("ANIM", "anim/veneto_jz.zip"),  
	Asset("ATLAS", "images/inventoryimages/veneto_jz.xml"), 
    Asset("IMAGE", "images/inventoryimages/veneto_jz.tex"),
}
...
local function onequip(inst, owner) 
	owner.AnimState:OverrideSymbol("swap_body", "veneto_jz", "swap_body")
...
local function fn()
    ...
    inst.AnimState:SetBank("veneto_jz")
    inst.AnimState:SetBuild("veneto_jz")
	...
	inst.components.inventoryitem.atlasname = "images/inventoryimages/veneto_jz.xml"  
    ...
    inst.components.armor:InitCondition(6000,0.95) 
...
return Prefab("veneto_jz", fn, assets)
