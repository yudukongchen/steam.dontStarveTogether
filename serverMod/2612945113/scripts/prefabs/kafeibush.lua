...
local function fn()
    ...
    inst.AnimState:OverrideSymbol("berries", "kafeibush", "coffees")
    inst.AnimState:OverrideSymbol("bush_berry_build", "kafeibush", "bush_coffee_build")
    inst.AnimState:SetTime(math.random() * inst.AnimState:GetCurrentAnimationLength())
    ...
    inst.components.pickable:SetUp("kafei", TUNING.BERRY_REGROW_TIME)
...
return Prefab("kafeibush", fn, assets)
