...
--local NOTAGS = { "FX", "NOCLICK", "DECOR", "INLIMBO", "burnt", "player","monster",} --不含营火
local NOTAGS = 					--不灭营火
{ "FX", "NOCLICK", "DECOR", "INLIMBO", "burnt", "player","monster","coldfire","firepit","campfire","coldfirepit"}
...
if   TUNING.MHQBMYH == 1
then local ents = TheSim:FindEntities(x, y, z, self.range, nil, { "FX", "NOCLICK", "DECOR", "INLIMBO", "burnt", "player","monster",}, NONEMERGENCYTAGS)
...
else local ents = TheSim:FindEntities(x, y, z, self.range, nil, { "FX", "NOCLICK", "DECOR", "INLIMBO", "burnt", "player","monster","coldfire","firepit","campfire","coldfirepit"}, NONEMERGENCYTAGS)	--不灭营火
...
if   TUNING.MHQBMYH == 1
then local ents = TheSim:FindEntities(x, y, z, self.range, { "fire" }, { "FX", "NOCLICK", "DECOR", "INLIMBO", "burnt", "player","monster",})
...
else local ents = TheSim:FindEntities(x, y, z, self.range, { "fire" }, { "FX", "NOCLICK", "DECOR", "INLIMBO", "burnt", "player","monster","coldfire","firepit","campfire","coldfirepit"})	--不灭营火
...
if   TUNING.MHQBMYH == 1
then local ents = TheSim:FindEntities(x, y, z, self.range, nil, { "FX", "NOCLICK", "DECOR", "INLIMBO", "burnt", "player","monster",}, EMERGENCYTAGS)
...
else local ents = TheSim:FindEntities(x, y, z, self.range, nil, { "FX", "NOCLICK", "DECOR", "INLIMBO", "burnt", "player","monster","coldfire","firepit","campfire","coldfirepit"}, EMERGENCYTAGS)	--不灭营火
