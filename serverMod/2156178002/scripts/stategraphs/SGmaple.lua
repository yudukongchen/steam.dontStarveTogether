...
local function SpawnLaser(inst)
	...
	if inst.components.inventory:GetEquippedItem(EQUIPSLOTS.HANDS) ~= nil then
		if inst.components.inventory:GetEquippedItem(EQUIPSLOTS.HANDS):HasTag("thecannon") then
			inst.components.inventory:GetEquippedItem(EQUIPSLOTS.HANDS).components.fueled:DoDelta(-10)
			if inst.components.inventory:GetEquippedItem(EQUIPSLOTS.HANDS).components.fueled:IsEmpty() then
			
				inst:DoTaskInTime(0.2, function() inst.components.inventory:GetEquippedItem(EQUIPSLOTS.HANDS):Remove() end)
    ...
    State{
        ...
        onenter = function(inst)
            ...
            elseif equip ~= nil and equip.components.weapon ~= nil and not equip:HasTag("punch") then
				...
				-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
				if equip:HasTag("thecannon") then
					SpawnLaser(inst)-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
