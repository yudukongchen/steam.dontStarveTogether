...
local LAUNCH_SPEED = 1 --.2
local RADIUS = 1 --.7
local SCALE_MULIPLIER = 1.8 --1
...
local DAMAGE_CANT_TAGS = { "player", "companion", "playerghost", "INLIMBO", --[["NOCLICK",]] "DECOR", "INLIMBO" }
local DAMAGE_ONEOF_TAGS = { "_combat", "CHOP_workable", "MINE_workable" } --{ "_combat", "pickable", "NPC_workable", "CHOP_workable", "HAMMER_workable", "MINE_workable", "DIG_workable" }
...
local function common_fn(isempty)
	...
	inst.Transform:SetScale((SCALE_MULIPLIER*1.5), (SCALE_MULIPLIER*1.5), (SCALE_MULIPLIER*1.5))------------------------------------------------------------------------------------------------------------
...
local function scorchfn()
	...
	inst.Transform:SetScale(SCALE_MULIPLIER, SCALE_MULIPLIER, SCALE_MULIPLIER)-------------------------------------------------------------------------------------------------------------------------------------
...
return Prefab("mechacannon_laser", fn, assets, prefabs),
