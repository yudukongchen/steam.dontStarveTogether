...
function Reticule:UpdatePosition(dt)
    if self.targetpos ~= nil then
		...
		if valid and TheWorld.Map:CanCastAtPoint(self.targetpos, alwayspassable, allowwater, deployradius) then
            self.currentcolour = self.validcolour -- Only affects color. See in aoespell_shield to restrain the spell cast
