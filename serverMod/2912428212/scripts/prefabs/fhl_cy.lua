local Assets = { Asset("ANIM", "anim/fhl_cy.zip"), Asset("ATLAS", "images/inventoryimages/fhl_cy.xml") }
...
local function fn(Sim)
    ...
    inst.components.perishable:SetPerishTime(TUNING.PERISH_PRESERVED * 20)
