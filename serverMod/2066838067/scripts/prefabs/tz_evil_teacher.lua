local assets =
{
    Asset("ANIM", "anim/evil_teacher.zip"),

    Asset("SOUND", "sound/together.fsb"),
	
	Asset( "IMAGE", "images/inventoryimages/tz_evil_teacher.tex" ),
    Asset( "ATLAS", "images/inventoryimages/tz_evil_teacher.xml" ),
}
...
local function fn()
    ...
    inst.AnimState:SetBuild("evil_teacher")
    inst.AnimState:PlayAnimation("idle")
	...
	inst.components.inventoryitem.atlasname = "images/inventoryimages/tz_evil_teacher.xml"
    inst:AddComponent("prototyper")
    inst.components.prototyper.onturnon = onturnon
    inst.components.prototyper.onturnoff = onturnoff
    inst.components.prototyper.onactivate = onactivate
    inst.components.prototyper.trees = TUNING.PROTOTYPER_TREES.TZ_EVIL_TEACHER_TWO
...
return Prefab("tz_evil_teacher", fn, assets)
