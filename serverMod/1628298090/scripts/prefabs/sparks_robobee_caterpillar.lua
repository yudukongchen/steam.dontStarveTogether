local assets =
{
	Asset("ANIM", "anim/sparks_robobee.zip"),
}
...
local function StartFX(proxy, animindex)
	...
	inst.AnimState:SetBuild("sparks_robobee")
	...
	inst.Light:SetColour(63 / 255, 177 / 255, 253 / 255)
...
return Prefab("sparks_robobee_caterpillar", fn, assets)