...
local function MakeHerd(pref, tag)
    ...
    local function fn()
        ...
        inst.components.herd:SetMemberTag(tag)
        ...
        inst.components.periodicspawner:SetPrefab(pref)
    ...
    return Prefab("py_"..pref.."herd", fn, nil)
end

return MakeHerd("spat", "spat"),
    MakeHerd("koalefant_winter", "koalefant"),
    MakeHerd("koalefant_summer", "koalefant"),
    MakeHerd("bearger", "bearger"),
    MakeHerd("deerclops", "deerclops")
