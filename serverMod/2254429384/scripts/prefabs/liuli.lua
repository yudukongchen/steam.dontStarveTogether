local assets =
{
    Asset("ANIM", "anim/liuli.zip"),
    Asset("ANIM", "anim/liuli_sw.zip"),
	Asset("ATLAS", "images/inventoryimages/liuli.xml"),
    Asset("IMAGE", "images/inventoryimages/liuli.tex"),
}
...
local function onequip(inst, owner) 
    owner.AnimState:OverrideSymbol("swap_object","liuli_sw","liuli")
...
local function fn()
    ...
    inst.AnimState:SetBank("liuli")
    inst.AnimState:SetBuild("liuli")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/liuli.xml"
...
return Prefab("liuli", fn, assets, prefabs)
