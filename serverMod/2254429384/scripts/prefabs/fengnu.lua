local assets =
{
    Asset("ANIM", "anim/fengnu.zip"),
    Asset("ANIM", "anim/fengnu_sw.zip"),
	Asset("ATLAS", "images/inventoryimages/fengnu.xml"),
    Asset("IMAGE", "images/inventoryimages/fengnu.tex"),
}
...
local function onequip(inst, owner) 
    owner.AnimState:OverrideSymbol("swap_object","fengnu_sw","fengnu")
...
local function fn()
    ...
    inst.AnimState:SetBank("fengnu")
    inst.AnimState:SetBuild("fengnu")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/fengnu.xml"
...
return Prefab("fengnu", fn, assets, prefabs)
