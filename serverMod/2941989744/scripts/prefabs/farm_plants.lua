    ...
    },
    {
        ...
        time = GetSpoilTime,
 		pregrowfn = function(inst)
			...
			inst.is_oversized = inst.krm_bullet3_buff or inst.force_oversized or (not inst.no_oversized and inst.components.farmplantstress ~= nil and inst.components.farmplantstress:GetFinalStressState() == FARM_PLANT_STRESS.NONE)
		end,
		fn = function(inst, stage, stage_data)
            MakePlantedSeed(inst, false)
            MakeRotten(inst, false)
