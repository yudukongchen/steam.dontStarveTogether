local function CreateLight()
    ...
    inst.Light:SetColour(12 / 255, 0 / 255, 160 / 255)
...
local ANIM_HAND_TEXTURE = softresolvefilepath("myfx/abcd.tex")
...
local function InitEnvelope()
    ...
    EnvelopeManager:AddColourEnvelope(
        ...
        {   { 0,    IntColour(60, 113, 186, 128) },
            { .19,  IntColour(60, 113, 186, 128) },
            { .35,  IntColour(113, 255, 253, 128) },
            { .51,  IntColour(11, 4, 217, 128) },
            { .75,  IntColour(11, 4, 217, 128) },
            { 1,    IntColour(12, 7, 255, 0) },
        }
    )
...
return MakeTorchFire("littlematchfire", assets, nil, common_postinit, master_postinit)