...
function MakeWallType(data)
    ...
    local function fn()
        ...
        MakeWaterObstaclePhysics(inst, 0.5, 0.5, 0.75)
        ...
        MakeInventoryFloatable(inst, "med", 0.1, {.5, .5, .5})
...
local walldata =
{
    { name = "sea_cobble", material = "stone", tags = { "stone" }, loot = "rocks", maxloots = 2, maxhealth = TUNING.STONEWALL_HEALTH,buildsound = "dontstarve/common/place_structure_stone" },
}
