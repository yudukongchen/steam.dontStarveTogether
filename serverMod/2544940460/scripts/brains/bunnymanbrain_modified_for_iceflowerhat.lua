...
local BunnymanBrain_modified_for_iceflowerhat = Class(Brain, function(self, inst)
    Brain._ctor(self, inst)
end)

function BunnymanBrain_modified_for_iceflowerhat:OnStart()
...
return BunnymanBrain_modified_for_iceflowerhat
