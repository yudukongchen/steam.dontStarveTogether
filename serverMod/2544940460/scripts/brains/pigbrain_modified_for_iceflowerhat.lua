...
local PigBrain_modified_for_iceflowerhat = Class(Brain, function(self, inst)
    Brain._ctor(self, inst)
end)

function PigBrain_modified_for_iceflowerhat:OnStart()
    --print(self.inst, "PigBrain_modified_for_iceflowerhat:OnStart")
...
return PigBrain_modified_for_iceflowerhat
